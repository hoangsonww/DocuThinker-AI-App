...
|---------------------------------|-----------------|-------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| `/sentiment-analysis`           | POST            | Analyzes the sentiment of the provided document text              | `{ "documentText": "string" }`                                                                                                 | `{ "sentimentScore": number, "description": "string" }`                                                  |
| `/bullet-summary`               | POST            | Generates a summary of the document text in bullet points         | `{ "documentText": "string" }`                                                                                                 | `{ "summary": "string" }`                                                                                |
| `/summary-in-language`          | POST            | Generates a summary in the specified language                     | `{ "documentText": "string", "language": "string" }`                                                                           | `{ "summary": "string" }`                                                                                |
| `/content-rewriting`            | POST            | Rewrites or rephrases the provided document text based on a style | `{ "documentText": "string", "style": "string" }`                                                                              | `{ "rewrittenContent": "string" }`                                                                      |
| `/actionable-recommendations`   | POST            | Generates actionable recommendations based on the document text   | `{ "documentText": "string" }`                                                                                                 | `{ "recommendations": "string" }`                                                                       |

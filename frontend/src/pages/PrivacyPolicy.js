  ...
  return (
      ...
      >
        ...
        <Box sx={{ maxWidth: '800px', margin: '0 auto' }}>
          ...
          <ul style={{ marginBottom: 3, paddingLeft: '20px', listStyleType: 'disc', font: 'inherit' }}>
            <li>
          ...
          <Typography variant="body1" sx={{ marginBottom: 3, font: 'inherit' }}>
            If you have any questions about this Privacy Policy or how we handle your personal information, please contact us at: <a style={{ color: isDark ? 'white' : 'black' }} href={`mailto:hoangson091104@gmail.com`}>hoangson091104@gmail.com.</a>
          </Typography>

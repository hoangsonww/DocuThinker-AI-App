...
export default function () {
  ...
  group('document_operations', () => {
    ...
    group('create_document', () => {
      ...
      const createRes = http.post(`${BASE_URL}/api/documents`, createPayload, { headers });
      ...
      if (createRes.status === 201) {
        ...
        // Retrieve document
        group('get_document', () => {
          const getRes = http.get(`${BASE_URL}/api/documents/${docId}`, { headers });
        ...
        group('search_documents', () => {
          const searchRes = http.get(`${BASE_URL}/api/documents/search?q=test`, { headers });
        ...
        group('delete_document', () => {
          const deleteRes = http.del(`${BASE_URL}/api/documents/${docId}`, null, { headers });
  ...
  group('ai_operations', () => {
    ...
    const aiRes = http.post(`${BASE_URL}/api/ai/analyze`, aiPayload, { headers });
  ...
  group('batch_operations', () => {
    ...
    const batchRes = http.post(`${BASE_URL}/api/documents/batch`, batchPayload, { headers });
